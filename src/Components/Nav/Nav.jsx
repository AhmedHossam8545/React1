      ...
      <div className="mx-auto  max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className=" nav-linkss flex flex-1 items-center justify-center sm:items-stretch lgnos:justify-start">
            ...
            <Link to={"/React1"} className="text-white text-3xl font-bold tracking-wider p-4 me-28 ">START REACT</Link>
            ...
            <div className="hidden lgnos:ml-6 lgnos:block">
              <div className="flex space-x-4">
                {/* {navigation.map((item) => (
                  ...
                  <div className="flex justify-between ms-96 	">
                  <NavLink to={"/React1/portfolio"} className="mx-4 text-lg font-bold   flex justify-center items-center p-4  " >PORTFOLIO</NavLink>
                  <NavLink to={"/React1/about"} className="mx-4 text-lg font-bold flex justify-center items-center p-4  ">ABOUT</NavLink>
                  <NavLink to={"/React1/contact"} className="mx-4 text-lg font-bold flex justify-center items-center p-4   ">CONTACT</NavLink>
                  </div>
                }
              </div>
            </div>
